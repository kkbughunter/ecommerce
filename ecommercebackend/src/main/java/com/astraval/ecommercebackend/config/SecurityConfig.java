    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/home-sliders/**").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/main-banners/**").permitAll()
                        ...
                        .requestMatchers(HttpMethod.PATCH, "/api/categories/**").hasRole("SUPER_ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/api/products/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/api/categories/**").hasRole("SUPER_ADMIN")
                        .requestMatchers("/api/admin/home-sliders/**", "/api/admin/main-banners/**")
                        .hasRole("SUPER_ADMIN")
