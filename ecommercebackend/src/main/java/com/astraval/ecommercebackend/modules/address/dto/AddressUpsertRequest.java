...
public record AddressUpsertRequest(
        ...
        @NotBlank(message = "Landmark is required") @Size(max = 150, message = "Landmark must be at most 150 characters") String landmark,
        @NotBlank(message = "City is required") @Size(max = 100, message = "City must be at most 100 characters") String city,
        @NotBlank(message = "District is required") @Size(max = 100, message = "District must be at most 100 characters") String district,
