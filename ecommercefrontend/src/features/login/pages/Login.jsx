                ...
                <div className="flex w-full items-center bg-[#f8f6ff] p-5 md:p-6 lg:w-[40%]">
                    <div className="mx-auto flex w-full max-w-sm flex-col gap-5">
                        ...
                        <p className="text-sm text-slate-600">
                            Sign in to manage products, orders, and customer activity in one
                            place.
                        </p>
                        ...
                        <form className="space-y-4" onSubmit={handleSubmit}>
                            ...
                            <button
                                type="submit"
                                disabled={isLoading}
                                className="h-11 w-full rounded-lg bg-gradient-to-r from-violet-500 to-blue-600 text-sm font-semibold text-white transition hover:brightness-105 cursor-pointer"
                            >
