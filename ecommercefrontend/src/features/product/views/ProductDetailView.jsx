...
const ProductDetailView = () => {
  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top,#eef2ff_0%,#f8fafc_52%,#f5f7fb_100%)] px-2 py-3 md:px-3 md:py-4">
      <section className="rounded-2xl border border-slate-200 bg-white p-3 shadow-[0_10px_30px_rgba(15,23,42,0.08)] sm:p-4">
